...
public class SettingsTextEntitiesGenerator {
    ...
    public static ArrayList<Object> getUserInfoList() {
        ...
        items.add(new SettingsTextEntity(SettingsTextEntity.TextType.SubTitle, "", "邮箱"));
        items.add(new SettingsTextEntity(SettingsTextEntity.TextType.SubTitle, "", "UID"));
    ...
    public static ArrayList<Object> getSupporList() {
        ArrayList<Object> items = new ArrayList<>();
        items.add(new SettingsTextEntity(SettingsTextEntity.TextType.PlainText, "手表信息", "手表信息"));
        items.add(new SettingsTextEntity(SettingsTextEntity.TextType.PlainText, "Telefriends FAQ", "Telefriends FAQ"));
